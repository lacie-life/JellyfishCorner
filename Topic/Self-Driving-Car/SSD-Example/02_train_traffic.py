...
dataPath = "/home/lacie/Github/ProgrammingLanguageCollection/Topic/Self-Driving-Car/SSD-Example/"
...
shape = (299, 299)
img_0_green = object_detection.load_images_rgb( dataPath + "traffic_dataset/0_green/*", shape)
img_1_yellow = object_detection.load_images_rgb(dataPath + "traffic_dataset/1_yellow/*", shape)
img_2_red = object_detection.load_images_rgb(dataPath + "traffic_dataset/2_red/*", shape)
img_3_not_traffic_light = object_detection.load_images_rgb(dataPath + "traffic_dataset/3_not/*", shape)
